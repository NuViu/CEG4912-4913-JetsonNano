...
class Object_detection:
    ...
    def run_object(self):
        ...
        video_path = x.detector.detectObjectsFromVideo(
                ...
                output_file_path=os.path.join(x.execution_path, "./output_video/camera_detect"),
                frames_per_second=1,  per_frame_function=x.forFrame,log_progress=True, minimum_percentage_probability=40,detection_timeout=10)
